...
import LeavesSheet from "./LeavesSheet";
...
const UserUI: React.FC = () => {
  ...
  const setShowDataState = (value: string) => {
    setshowdata(value);
  };
    ...
    <div>
      <AppBar position="sticky" className="top-0">
        <Toolbar className="bg-slate-50">
          ...
          <div className="w-52 me-2 p-1 ">
            <img
              src="https://www.fireflink.com/static/media/fireflink.0d427889.svg"
              alt="Company Logo"
              height={"100%"}
              width={"100%"}
            />
          ...
          <div className="flex-grow-1">
            <span className=" text-blue-800 float-end me-4 font-semibold text-lg">
              Welcome
          ...
          <div className="w-8 h-10 flex justify-center align-items-center">
            ...
            >
              <MenuItem onClick={handleClose}>
                E-Name :- {user?.name.toUpperCase()}
              </MenuItem>
              <MenuItem onClick={handleClose}>E-Id :- {user?.empId}</MenuItem>
              <Link to={"/"}>
      ...
      <Box sx={{ display: "flex" }}>
        ...
        >
          ...
          <Divider />
          <List>
            {["TimeSheet", "LeaveSheet", "History"].map((text, index) => (
        ...
        <Main open={open} className="flex justify-center">
              ...
              >
                <Row className="h-100 w-100 m-auto rounded-xl  ">
                  <Row className="mx-auto  h-100 w-100">
                    <img
                      src="https://media.istockphoto.com/id/1169207942/photo/clock-and-calendar.webp?b=1&s=170667a&w=0&k=20&c=JKICo8grtA00cja4isDWCScUzQfKprFnCmQOs0DhnAI= "
                      height={"90%"}
                      width={"90%"}
                      alt=""
                    />
          ...
          {showdata === "TimeSheet" && (
            <div className="w-7/12 h-5/6 absolute m-auto flex align-items-center">
              <TimeSheet setshowdata={setShowDataState} />
            </div>
          )}
          {showdata === "LeaveSheet" && (
            <div className="w-7/12 h-5/6 absolute m-auto flex align-items-center">
              <LeavesSheet setshowdata={setShowDataState} />
            </div>
          )}
          {showdata === "History" && (
            <div className="w-7/12 h-5/6 absolute m-auto flex align-items-center">
